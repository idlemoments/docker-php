![Status](https://github.com/viusystems/docker-php/actions/workflows/ci.yml/badge.svg)
...
# Supported tags and respective `Dockerfile` links
 ...
 - `7.4-fpm`, `7-fpm`, `latest` (*[7.4/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.4/fpm/Dockerfile)*)
 
 - `7.4-fpm-dev` (*[7.4/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.4/fpm/dev/Dockerfile)*)
 - `7.4-apache-dev` (*[7.4/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.4/apache/Dockerfile)*)
 - `7.4-apache-dev` (*[7.4/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.4/apache/dev/Dockerfile)*)

 - `7.3-fpm` (*[7.3/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.3/fpm/Dockerfile)*)
 - `7.3-fpm-dev` (*[7.3/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.3/fpm/dev/Dockerfile)*)
 - `7.3-apache-dev` (*[7.3/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.3/apache/Dockerfile)*)
 - `7.3-apache-dev` (*[7.3/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.3/apache/dev/Dockerfile)*)

 - `7.2-fpm` (*[7.2/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.2/fpm/Dockerfile)*)
 - `7.2-fpm-dev` (*[7.2/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.2/fpm/dev/Dockerfile)*)
 - `7.2-apache` (*[7.2/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.2/apache/Dockerfile)*)
 - `7.2-apache-dev` (*[7.2/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.2/apache/dev/Dockerfile)*)

 - `7.1-fpm` (*[7.1/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.1/fpm/Dockerfile)*)
 - `7.1-fpm-dev` (*[7.1/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.1/fpm/dev/Dockerfile)*)
 - `7.1-apache` (*[7.1/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.1/apache/Dockerfile)*)
 - `7.1-apache-dev` (*[7.1/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.1/apache/dev/Dockerfile)*)

 - `7.0-fpm` (*[7.0/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.0/fpm/Dockerfile)*)
 - `7.0-fpm-dev` (*[7.0/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.0/fpm/dev/Dockerfile)*)
 - `7.0-apache` (*[7.0/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.0/apache/Dockerfile)*)
 - `7.0-apache-dev` (*[7.0/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/7.0/apache/dev/Dockerfile)*)

 - `5.6-fpm` (*[5.6/fpm/Dockerfile](https://github.com/viusystems/docker-php/blob/master/5.6/fpm/Dockerfile)*)
 - `5.6-fpm-dev` (*[5.6/fpm/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/5.6/fpm/dev/Dockerfile)*)
 - `5.6-apache` (*[5.6/apache/Dockerfile](https://github.com/viusystems/docker-php/blob/master/5.6/apache/Dockerfile)*)
 - `5.6-apache-dev` (*[5.6/apache/dev/Dockerfile](https://github.com/viusystems/docker-php/blob/master/5.6/apache/dev/Dockerfile)*)
